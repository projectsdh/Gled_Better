...
import 'package:gladbettor/widgets/SearchBar/scaled_tile.dart';
import 'package:gladbettor/widgets/SearchBar/search_bar_style.dart';
...
class SearchBar<T> extends StatefulWidget {
  ...
  SearchBar({
    ...
    this.textStyle = const TextStyle(color: Colors.black, fontSize: 15),
                    ...
                    children: [
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding:
                          EdgeInsets.only(top: -14, left: -10, right: 30),
                        ),
                      ),
